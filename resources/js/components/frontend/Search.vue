<template>
    <span>
        <section class="medium-gap standard-home">
            <div class="container">
                <div class="row"><div class="col-lg-8" v-if="posts ==[]">
                ...
                <div class="col-lg-8" v-if="posts !==null">
                    <div class="standard-posts">
                    <div class="row">
                        <div class="col-lg-12" v-for="(post, i) in posts" :key="i">
...
export default {
    ...
    metaInfo() {
        return { 
            title: "Search Result - Foreign Company Registration Consultant",
            meta: [
                { name: 'description', content:  'Search Result - Foreign Company Registration Consultant'},
                { property: 'og:title', content: "Search Result - Foreign Company Registration Consultant"},
                { property: 'og:description', content: "Search Result - Foreign Company Registration Consultant"},
    ...
    methods:{
        /*getResults(page = 1) {
            axios.get('search/'+this.$route.params.keyword+'?page='+ page)
            .then(({data}) => (this.posts = data))
        },*/
        loadPost(){
            axios.get('search?q='+this.$route.params.keyword)
            .then(({data}) => (this.posts = data))
        },
