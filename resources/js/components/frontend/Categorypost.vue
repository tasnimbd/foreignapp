            ...
            <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                        <ul class="pagination">
                            <pagination :data="posts" @pagination-change-page="getCatResults"></pagination>
                        </ul>
                        </div>
                    </div>
                    </div>
...
export default {
    ...
    methods:{
        getCatResults(page = 1) {
            axios.get('pubgetcatpost/'+this.$route.params.cat_slug+'?page=' + page)
            .then(({data}) => (this.posts = data))
        },
        loadCatPost(){
            axios.get('pubgetcatpost/'+this.$route.params.cat_slug)
            .then(({data}) => (this.posts = data))
        },
